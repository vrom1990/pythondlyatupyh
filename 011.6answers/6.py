    ...
    if vybor == "1":
        ...
        if vybor == "1":
            ...
            if vybor == "1":
                ...
                print("Ингеборга: Спасибо за вечер! Ну, мне пора.")
            elif vybor == "2":
                print("Ингеборга: Ладно...")
                print("Вы сидите ещё какое-то время")
                print("Ингеборга: Ладно, пока! Мне пора.")
            elif vybor == "3":
                ochki = ochki + 2
                print("Ингеборга: Здорово!...")
                print("Вы фотографируетесь, а потом идёте фотографироваться на скалу.")
                print("Ингеборга: Спасибо!")
                print("Варианты ответа(введите 1, 2 или 3): ",
              "1: Предложить ей потанцевать в лучах заката",
              "2: Попрощаться",   
              sep="\n")
        elif vybor == "3":
