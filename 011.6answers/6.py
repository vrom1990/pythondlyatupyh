...
if vybor == "Пляж":
    ...
    if vybor == "посмотреть на море":
        ...
        print("Варианты ответа: ",
              "Просто посидим на песке",
              "Я прихватил плед и корзиночку с едой и напитками",
              "Я арендую беседку с шикарным видом, нам приготовят готовую еду",
              sep="\n")
        vybor = input("Просто посидим на песке")
